# AWS CodeStar Project\-Level Policies and Permissions<a name="security_iam-proj"></a>
...
## IAM Policy for the Execution Role<a name="security_iam-proj-policy-execution"></a>
