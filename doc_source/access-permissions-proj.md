...
When you create a project, CodeStar creates the IAM roles and policies you need to manage your project resources\. The policies that AWS CodeStar creates fall into three categories: 
...
1. Select the template, then click **Actions** and click **View/Edit template in Designer**\.
...
1. Push a change through your project pipeline so that CodeStar updates the permissions boundary with appropriate permissions\.
